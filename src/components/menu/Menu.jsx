  ...
  return (
    <>
      ...
      <div className="w-fit h-[90px] flex flex-row-reverse justify-end items-center relative py-2">
        ...
        {/* Button Inbox */}
        <div
          className={`flex flex-col h-full mt-2 py-2 ${
            selectedButton === "Inbox" ? "justify-end" : "justify-center"
          } items-center absolute transition-all duration-500 z-20 transform ${
        ...
        >
          <span
            className={`font-latoBold text-[0.7rem] text-[#FFFFFF] ${
          ...
          <div className="relative">
            {selectedButton === "Inbox" && (
              <div className="absolute w-12 h-12 bg-[#4F4F4F] rounded-full -z-10 left-[-10px] top-[8px]"></div>
            )}
            <button
              type="button"
              id="buttonModalInbox"
              onClick={() => handleButtonClick("Inbox")}
              className={`${selectedButton === "Task" ? "mt-7" : "mt-2"} ${
                selectedButton === "Inbox"
                  ? "w-12 h-12 bg-indicator-purple"
                  : "w-10 h-10 bg-[#FFFFFF]"
              } ${
                isBubbleClicked ? "mt-0" : ""
              } rounded-full shadow-md flex items-center justify-center relative z-20`}
            >
              <Icons.InboxIcon
        ...
        <div
          ...
          } items-center absolute transition-all duration-500 z-10 transform ${
        ...
        >
          ...
          <div className="relative">
            ...
            <button
              ...
              className={`${selectedButton === "Inbox" ? "mt-7" : "mt-2"} ${
                selectedButton === "Task"
